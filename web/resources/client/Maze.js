...
function init() 
{
	...
	// CAMERA
	var SCREEN_WIDTH = 1170, SCREEN_HEIGHT = window.innerHeight;
	...
	// basic moon
	var moonTexture = THREE.ImageUtils.loadTexture( 'static/img/moon.jpg' );
	...
	var materialArray = [];
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'static/img/Dice-Blue-1.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'static/img/Dice-Blue-6.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'static/img/Dice-Blue-2.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'static/img/Dice-Blue-5.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'static/img/Dice-Blue-3.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'static/img/Dice-Blue-4.png' ) }));
